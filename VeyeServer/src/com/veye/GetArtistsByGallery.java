 ...
 */
public class GetArtistsByGallery extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetArtistsByGallery() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		JsonObject returnJson = this.getArtistByGallery(galleryId);
	...
	private JsonObject getArtistByGallery(String galleryId) {
