 ...
 */
public class GetAllAddressesByUser extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetAllAddressesByUser() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		JsonObject returnJson = this.getAddressesByUser(userId);
	...
	private JsonObject getAddressesByUser(String userId) {
		...
		try {
			...
			//获取address
			String sql = "select * from address where userid=" + userId + " order by id desc";
