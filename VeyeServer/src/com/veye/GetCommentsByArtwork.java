 ...
 */
public class GetCommentsByArtwork extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetCommentsByArtwork() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		JsonObject returnJson = this.getCommentsById(artworkId);
	...
	private JsonObject getCommentsById(String artworkId) {
