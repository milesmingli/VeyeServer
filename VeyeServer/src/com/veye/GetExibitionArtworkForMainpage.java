 ...
 */
public class GetExibitionArtworkForMainpage extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetExibitionArtworkForMainpage() {
		super();
	...
	private JsonObject getGalleryArtworkForMainpage() {
		...
		try {
			...
			sql = sql + " FROM exhibition as a, gallery as b where a.galleryid = b.id order by a.starttime desc ";
