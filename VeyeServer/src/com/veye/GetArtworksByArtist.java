 ...
 */
public class GetArtworksByArtist extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetArtworksByArtist() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		JsonObject returnJson = this.getArtworkById(artiestId);
	...
	private JsonObject getArtworkById(String artistId) {
