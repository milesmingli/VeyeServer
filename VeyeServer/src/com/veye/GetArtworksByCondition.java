 ...
 */
public class GetArtworksByCondition extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public GetArtworksByCondition() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		String condition = URLDecoder
				.decode(request.getParameter("condition"), "UTF-8");
		...
		JsonObject returnJson = this.getArtworkByCondition(condition);
	...
	private JsonObject getArtworkByCondition(String condition) {
