 ...
 */
public class CheckOrderStock extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CheckOrderStock() {
		super();
	...
	protected void doPost(HttpServletRequest request,
		...
		JsonObject returnJson = this.getArtworkByOrderId(orderId);
	...
	private JsonObject getArtworkByOrderId(String orderId) {
		...
		try {
			...
			//获取gallery
			String sql = "select id, name, stock from artwork_view where id in (select artworkid from order_item where orderid = " + orderId + ")";
