...
public class DeleteComment extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		String commentId = URLDecoder.decode(request.getParameter("commentid"),
				"UTF-8");

	
		JsonObject returnJson = this.deleteComment(commentId);
	...
	private JsonObject deleteComment(String commentId) {
