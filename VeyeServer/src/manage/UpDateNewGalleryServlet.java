...
public class UpDateNewGalleryServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * Constructor of the object.
	 */
	public UpDateNewGalleryServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			// SQL语句
				...
				String owner_artist=null;
				if(RsStream==""||RsStream==null ){
					
					sql = "update gallery set name='" + name +"', type='"+type+"' ,brief='"+ brief+"',owner_artist="+owner_artist+" ,province='" +province+"',city='" +city+"',district='" +district+"',address='" +address+"',contactperson='" +contactperson+"', phone='"+phone+"', telephone='"+telephone+"', fax='"+fax+"', web='"+web+"',email='"+email+"' where id="
							+"'"+ userid+"'";
