...
public class MangeExhibitionArtworkServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * Constructor of the object.
	 */
	public MangeExhibitionArtworkServlet() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			while  (rs.next()) {
				...
				String data=rs.getString("id")+","+rs.getString("name")+","+rs.getString("thumbnail")+","+rs.getString("galleryid");
