		...
		try {
			...
			// SQL语句
				if(isgallery.equals("否")){
					...
					sql = "insert into artist (id,name,birthday,brief,gender,prov,city,district,artistcategory,country,phone,telephone,fax,web,email,portrait,hasgallery) values('";
					sql = sql +userid+"','"+name+"','"+birthday+"','"+brief+"','"+gender+"','"+prov+"','"+city+"','"+district+"','"+artistcategory+"','"+country+"','"+phone+"','"+telephone+"','"+fax+"','"+web+"','"+email+"','"+relativepath+"',1,"+isaudit+","+id+")";
					
					sql1 = "insert into gallery (id,name,brief,type,owner_artist,province,city,district,phone,telephone,fax,web,email,portrait,updatetime) values('";
					sql1 = sql1 +userid+"','"+name+"','"+brief+"','"+"个人"+"','"+userid+ "','"+prov+"','"+city+"','"+district+"','"+phone+"','"+telephone+"','"+fax+"','"+web+"','"+email+"','"+relativepath+"','"+date+"')";
