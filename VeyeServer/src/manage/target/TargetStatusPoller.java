...
public class TargetStatusPoller {
	...
	public TargetStatusPoller(float interval_minutes, String target_id, String server_access_key, String server_secret_key){
	...
	public static TargetStatusListener PollerTask() {
