 ...
 * Note: a target that has status of 揚rocessing�cannot be deleted.
...
public class DeleteTarget implements TargetStatusListener {
	...
	private static final float pollingIntervalMinutes = 60;//poll at 1-hour interval
	public static String GettargetId(String id){
		
		targetId=id;
		System.out.println(id);
		deactivateThenDeleteTarget();
		return id;
	}
	...
	private static void updateTargetActivation(Boolean b) throws URISyntaxException, ClientProtocolException, IOException, JSONException {
	...
	public static void deactivateThenDeleteTarget() {
		...
		targetStatusPoller = new TargetStatusPoller(pollingIntervalMinutes, targetId, accessKey, secretKey);
	...
	public static void main(String[] args) throws URISyntaxException, ClientProtocolException, IOException {
		...
		d.GettargetId("142c007e77474cd3ba8f77d29f8eb470");
