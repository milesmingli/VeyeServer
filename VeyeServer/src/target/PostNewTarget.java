...
public class PostNewTarget implements TargetStatusListener {
	...
	//Server Keys
	private String accessKey = "dd05ece5347229d3cddc042dcb2776a1615cebdc";
	private String secretKey = "ba5724fdfbc4b063a5154e47b3e95f79df8d96d2";
	
	private String url = "https://vws.vuforia.com";
	private String targetName = "abc";
	private String imageLocation = "c:/target.jpg";
	...
	private void setRequestBody(JSONObject requestBody) throws IOException, JSONException {
		...
		requestBody.put("application_metadata", Base64.encodeBase64String("{'type':'gallery','galleryid':'1'}".getBytes())); // Optional
	}
